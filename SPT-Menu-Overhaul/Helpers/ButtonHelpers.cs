...
namespace MoxoPixel.MenuOverhaul.Helpers
{
    internal static class ButtonHelpers
    {
        ...
        private static readonly string[] ButtonNames = ["PlayButton", "CharacterButton", "TradeButton", "HideoutButton", "MessengerButton", "HandbookButton", "PresetsButton", "ExitButtonGroup"
        ];
        ...
        public static void SetupButtonIcons(MenuScreen menuScreenInstance)
        {
            ...
            SetButtonIconTransform(menuScreenInstance, "MessengerButton", new Vector3(ButtonIconScale, ButtonIconScale, ButtonIconScale));
            SetButtonIconTransform(menuScreenInstance, "HandbookButton", new Vector3(ButtonIconScale, ButtonIconScale, ButtonIconScale));
            SetButtonIconTransform(menuScreenInstance, "PresetsButton", new Vector3(ButtonIconScale, ButtonIconScale, ButtonIconScale));
